...
#    And I click finish building item now
  ...
  Scenario: upgrade research lab from level 1 to level 20
    ...
    And I should get highest level research lab on base view