@build_and_upgrade_resource_vault
Feature: Upgrade existing buildings
  As an Player
  I want to upgrade existing buildings

#  @01_build_resource_vault
#  Scenario: build resource vault
#    Given I launch the game on dev environment and skip fte
#    And I am on my base view
#    And I build 3 resource vaults
#    And I build 1 resource vaults

  @01_upgrade_resource_vault
  Scenario: upgrade resource vault from level 1 to level 20
    Given I launch the game on dev environment and skip fte
    And I am on my base view
    And I tap on level 1 resource vault
    ...
    And I should get highest level resource vault on base view