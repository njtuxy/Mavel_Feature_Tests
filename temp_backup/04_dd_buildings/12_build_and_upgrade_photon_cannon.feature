...
#    And I build 1 photon cannons
  ...
  Scenario: upgrade missile launcher from level 1 to level 20
    ...
    And I should get highest level photon cannon on base view
