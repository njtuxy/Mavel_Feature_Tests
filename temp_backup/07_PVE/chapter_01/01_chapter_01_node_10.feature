@pve_chatper_01_node_10
Feature: pve battle
  As an Player
  I want to play pve battles

  @01_chapter_01_node_10_tier_1_to_3
  Scenario: chapter_01_node_10_tier_1_to_3_pve
    Given I have 43 a3 phoenix
    And I launch the game on dev environment and skip fte
    And I am on my base view
    And I attack "chapter 1 node 10" with 14 units for 3 times

  @01_chapter_01_node_10_tier_4_to_5
  Scenario: chapter_01_node_10_tier_4_to_5_pve
    Given I have 43 a3 phoenix
    And I relaunch the game on dev environment and skip fte
    And I am on my base view
    And I attack "chapter 1 node 10" with 20 units for 2 times

#  @01_chapter_01_node_10
#  Scenario: chapter 01 node 10 pve battle
...
#    And I click "chapter 1 node 10" to attack
